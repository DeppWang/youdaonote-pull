...
class YoudaoNotePull(object):
    ...
    def _add_or_update_file(self, file_id, file_name, local_dir, modify_time):
        ...
        try:
            self._pull_file(file_id, original_file_path, local_file_path, note_type, youdao_file_suffix)
    ...
    def _pull_file(self, file_id, file_path, local_file_path, note_type, youdao_file_suffix):
        """
        下载文件
        :param file_id:
        :param file_path:
        ...
        if note_type or youdao_file_suffix == MARKDOWN_SUFFIX:
            imagePull = ImagePull(self.youdaonote_api, self.smms_secret_token, self.is_relative_path)
